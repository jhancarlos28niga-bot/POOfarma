...
public class medicamentos extends javax.swing.JPanel {
    ...
    private void listarMedicamentos() {
        ...
        DefaultTableModel modelo =
                (DefaultTableModel) jtablaMedicamentos.getModel();
    ...
    private void initComponents() {
        ...
        jtablaMedicamentos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Categoría", "Stock", "Precio", "Fecha_Vencimiento", "Laboratorio"
            }
        ));
        ...
        cbCategoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar Categoría", "Tabletas", "Jarabe", "Cápsula", "Inyectable", "Crema" }));
